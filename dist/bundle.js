...
var App = function (_React$Component) {
    ...
    function App(props) {
        ...
        _this.submitChangeReg = _this.submitChangeReg.bind(_this);
        _this.submitChangeSpe = _this.submitChangeSpe.bind(_this);
    ...
    _createClass(App, [{
        ...
        value: function componentDidMount() {
            ...
            _axios2.default.get('/api/regProduct/').then(function (res) {
                return res.data;
            }).then(function (products) {
                _this2.setState({ regProducts: products });
            });

            _axios2.default.get('/api/speProduct/').then(function (res) {
                return res.data;
            }).then(function (products) {
                _this2.setState({ speProducts: products });
            });
        }
    }, {
        key: 'handleChange',
        ...
        key: 'submitChangeReg',
        value: function submitChangeReg(evt) {
            evt.preventDefault();
            console.log(this.state.inputValue);

            _axios2.default.post('/api/speProduct', { name: this.state.inputValue }).then(function (res) {
                return res.data;
        ...
        key: 'submitChangeSpe',
        value: function submitChangeSpe(evt) {
            evt.preventDefault();
            console.log(this.state.inputValue);

            _axios2.default.post('/api/regProduct', { name: this.state.inputValue }).then(function (res) {
                return res.data;
            }).then(function (result) {
                console.log(result); // response json from the server!
            });
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                'div',
                null,
                _react2.default.createElement(_Products2.default, { Products: this.state.regProducts, submitChange: this.submitChangeReg, handleChange: this.handleChange }),
                _react2.default.createElement('hr', null),
                _react2.default.createElement(_Products2.default, { Products: this.state.speProducts, submitChange: this.submitChangeSpe, handleChange: this.handleChange })
            );
        }
    }]);
